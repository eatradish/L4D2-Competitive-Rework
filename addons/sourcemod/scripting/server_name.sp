// ============================================================================
// [第三方源码存档] 同步自 Anne 的 CompetitiveWithAnne 仓库，代码未做任何修改（仅此标注块）。
// 来源：https://github.com/fantasylidong/CompetitiveWithAnne
//       addons/sourcemod/scripting/extend/server_name.sp
// 版本：1.4.8（作者：东） | 同步自 master@6be5a587（2026-08-13）。
// 作用：服务器名动态更新；模式标签取自 cvar l4d_ready_cfg_name（各模式 confogl.cfg 设置）。
//       线上运行的是 Anne 包内的编译产物；本文件仅作参考/比对，不做本地修改。
// ============================================================================
